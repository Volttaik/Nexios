...
export default function Header() {
  ...
  return (
    <header 
      ref={headerRef}
      className="fixed top-0 left-0 right-0 bg-white/70 backdrop-blur-md z-50 border-b border-gray-200/50"
    >
          ...
          <div className="flex items-center gap-2">
            <Link href="/" className="flex items-center gap-2 group">
              ...
              <div className="flex items-center">
                ...
                <span className="text-xl font-bold text-white bg-gradient-to-r from-gray-800 to-gray-700 px-2 py-0.5 rounded-lg ml-1 shadow-sm">
                  AI
                </span>
              </div>
            </Link>
          ...
          <div className="flex items-center gap-3">
            <button 
              ...
              className={`relative w-8 h-8 flex items-center justify-center rounded-lg transition-all duration-300 ${
                isMenuOpen ? 'bg-gray-900' : 'hover:bg-gray-100/80'
              }`}
            ...
            >
              {isMenuOpen ? (
                ...
                <HiMenu className="w-4 h-4 text-gray-700" />
              )}
            </button>
          </div>
        </div>
