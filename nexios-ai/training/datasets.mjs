...
export const VALIDATION_PROMPTS = [
  { input: "hello", category: "general", mustContain: ["hello", "hi", "assist", "help"] },
  { input: "what is javascript", category: "programming", mustContain: ["javascript", "web", "language"] },
  { input: "what is ui design", category: "design", mustContain: ["interface", "visual", "design"] },
  { input: "what is the pythagorean theorem", category: "mathematics", mustContain: ["triangle", "hypotenuse", "²"] },
  { input: "what is gravity", category: "science", mustContain: ["force", "mass", "attraction"] },
  { input: "write a react component", category: "programming", mustContain: ["function", "return", "useState"] },
  { input: "explain async await", category: "programming", mustContain: ["promise", "async", "await"] },
  { input: "what makes a good button design", category: "design", mustContain: ["button", "contrast", "padding"] },
];
